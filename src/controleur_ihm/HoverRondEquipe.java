...
public class HoverRondEquipe implements MouseListener{
	...
	public HoverRondEquipe(PopupIndiquerVainqueur vue) {
		super();
		this.vue = vue;
	}
	...
	public void mouseClicked(MouseEvent e) {
		...
		case "panelEquipe1" :
			...
			this.vue.getPanelEquipe1().setBackground(HoverRondEquipe.COULEUR_VAINQUEUR_HOVER);
		...
		case "panelEquipe2" : 
			...
			this.vue.getPanelEquipe2().setBackground(HoverRondEquipe.COULEUR_VAINQUEUR_HOVER);
